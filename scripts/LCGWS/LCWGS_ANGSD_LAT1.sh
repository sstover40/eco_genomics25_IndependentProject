...
PARAM1="/gpfs1/cl/ecogen/pbio6800/GroupProjects/tripods/data/lat_samp_GW.txt"
PARAM2="/gpfs1/cl/ecogen/pbio6800/GroupProjects/tripods/data/lat_samp_MR.txt"
...
SUFFIX="LAT1"  # Optional suffix for naming outputs to distinguish analyses
